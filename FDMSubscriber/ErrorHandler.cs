...
namespace DDSErrorHandle
{
    ...
    public sealed class ErrorHandler
    {
        ...
        public static void checkStatus(ReturnCode status, string info)
        {
            ...
            {
                System.Console.WriteLine("Error in " + info + ": " + getErrorName(status));
                //MessageBox.Show("Error in " + info + ": " + getErrorName(status));
        ...
        public static void checkHandle(object handle, string info)
        {
            if (handle == null)
            {
                //MessageBox.Show("Error in " + info + ": Creation failed: invalid handle");
                System.Console.WriteLine("Error in " + info + ": Creation failed: invalid handle");
                System.Environment.Exit(-1);
            }
        }
